                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="gallery-item hover-img wow fadeInUp" data-wow-delay=".2s">
                                <div class="img-style">
                                    <img class="lazyload img-hover" data-src="/frontend/images/shop/gallery/gallery-7.jpg"
                                        src="/frontend/images/shop/gallery/gallery-7.jpg" alt="image-gallery">
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="gallery-item hover-img wow fadeInUp" data-wow-delay=".3s">
                                <div class="img-style">
                                    <img class="lazyload img-hover" data-src="/frontend/images/shop/gallery/gallery-3.jpg"
                                        src="/frontend/images/shop/gallery/gallery-3.jpg" alt="image-gallery">
                                </div>
                                <a href="#quick_add" data-bs-toggle="modal" class="box-icon"><span
                                        class="icon icon-bag"></span> <span class="tooltip">Quick Add</span></a>
                            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="gallery-item hover-img wow fadeInUp" data-wow-delay=".4s">
                                <div class="img-style">
                                    <img class="lazyload img-hover" data-src="/frontend/images/shop/gallery/gallery-5.jpg"
                                        src="/frontend/images/shop/gallery/gallery-5.jpg" alt="image-gallery">
                                </div>
                                <a href="#quick_add" data-bs-toggle="modal" class="box-icon"><span
                                        class="icon icon-bag"></span> <span class="tooltip">Quick Add</span></a>
                            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="gallery-item hover-img wow fadeInUp" data-wow-delay=".5s">
                                <div class="img-style">
                                    <img class="lazyload img-hover" data-src="/frontend/images/shop/gallery/gallery-8.jpg"
                                        src="/frontend/images/shop/gallery/gallery-8.jpg" alt="image-gallery">
                                </div>
                                <a href="#0" class="box-icon"><span class="icon icon-bag"></span> <span
                        ...
                        <div class="swiper-slide">
                            <div class="gallery-item hover-img wow fadeInUp" data-wow-delay=".6s">
                                <div class="img-style">
                                    <img class="lazyload img-hover" data-src="/frontend/images/shop/gallery/gallery-6.jpg"
                                        src="/frontend/images/shop/gallery/gallery-6.jpg" alt="image-gallery">
                                </div>
                                <a href="#0" class="box-icon"><span class="icon icon-bag"></span> <span
                                        class="tooltip">View product</span></a>
                            </div>
