...
<body class="preload-wrapper popup-loader">
                    ...
                    <div class="col-xl-9 col-md-4 col-6">
                        <div class="wrap-header-left">
                            <a href="/" class="logo-header">
                                <img src="/frontend/tcul-img/Itsroop.webp" alt="logo" class="logo"
                                    style="width: 180px;">
                            </a>
                            <nav class="box-navigation text-center">
                                <ul class="box-nav-ul d-flex align-items-center justify-content-center gap-30">
                                    <li class="menu-item"><a href="/" class="item-link text_green-1">Home</a></li>
                                    <li class="menu-item"><a href="/products"
                                            class="item-link text_green-1">Products</a></li>
                                    <li class="menu-item"><a href="/about" class="item-link text_green-1">About</a>
                                    </li>
                                    <li class="menu-item"><a href="/blogs" class="item-link text_green-1">Blogs</a>
                                    </li>
                            ...
                            <div class="col-xl-3 col-md-6 col-12">
                                <div class="footer-col footer-col-2 footer-col-block">
                                    ...
                                    <ul class="footer-menu-list tf-collapse-content">
                                        ...
                                        @endauth
                                        <li>
                                            <a href="/contact#faq" class="footer-menu_item">FAQ's</a>
                                        </li>
                                        <li>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div
                                    ...
                                    <div class="footer-menu_item" style="color: white; font-weight: 500;">© 2025
                                        Bamboo Street. All Rights Reserved</div>
                                    <div class="tf-payment d-flex align-items-center gap-10">
                                        <span style="color: white;">We are also available on</span>
                                        <a href="https://www.amazon.in/s?k=Bamboo+Street&ref=bl_dp_s_web_0"
                                            target="_blank"
                                            style="display: flex; align-items: center; text-decoration: none;">
                                            <img src="/frontend/images/footer/amazon-icon.png" alt="Amazon"
    ...
    <div class="floating-buttons">
        ...
        <div class="whatsapp-wrap">
            <a href="https://wa.me/7304229346" target="_blank">
                <svg class="whatsapp-circle svg-content" width="100%" height="100%" viewBox="-1 -1 102 102">
                    ...
                    <li class="nav-mb-item">
                        ...
                        <div id="dropdown-menu-five" class="collapse">
                            <ul class="sub-nav-menu">
                                <li><a href="{{ route('frontend.wishlists') }}" class="sub-nav-link">My Wishlists</a>
                                </li>
                                <li><a href="{{ route('frontend.orders') }}" class="sub-nav-link">My Orders</a></li>
