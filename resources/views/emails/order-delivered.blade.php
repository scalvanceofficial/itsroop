...
<body>
    ...
    <p>We’re happy to let you know that your order <strong>#{{ $data['order_number'] }}</strong> has been
        <strong>delivered</strong> successfully. 🎉
    </p>

    <p>We hope you enjoy your new Bamboo Street products and continue your journey toward a greener lifestyle! 🍀</p>
